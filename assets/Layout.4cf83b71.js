...
import { h as defineComponent, k as useRoute, l as toRefs, m as computed, p as isLinkHttp, q as isLinkMailto, s as isLinkTel, r as resolveComponent, j as unref, o as openBlock, v as createBlock, w as withCtx, f as renderSlot, e as createTextVNode, t as toDisplayString, x as mergeProps, a as createElementBlock, y as createCommentVNode, z as useSiteData, A as usePageFrontmatter, B as useSiteLocaleData, C as withBase, D as isArray, b as createBaseVNode, F as Fragment, E as renderList, d as createVNode, g as normalizeClass, G as removeLeadingSlash, H as removeEndingSlash, i as useThemeLocaleData, I as usePageData, J as useSidebarItems, K as isString, L as useNavLink, M as isPlainObject, T as Transition, N as ref, O as watch, P as withDirectives, Q as vShow, R as useRouter, u as useRouteLocale, S as useDarkMode, c as createStaticVNode, U as onMounted, n as normalizeStyle, V as h, W as onUnmounted, X as useScrollPromise } from "./app.95e2640d.js";
const _hoisted_1$a = ["href", "rel", "target", "aria-label"];
const __default__ = defineComponent({
  inheritAttrs: false
});
var _sfc_main$c = defineComponent(__spreadProps(__spreadValues({}, __default__), {
  props: {
    item: {
      type: Object,
      required: true
...
const _hoisted_1$8 = { class: "page-meta" };
const _hoisted_2$6 = {
  key: 0,
...
const _hoisted_5$2 = { class: "meta-item-info" };
const _hoisted_6$2 = {
  key: 2,
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("footer", _hoisted_1$8, [
        unref(editNavLink) ? (openBlock(), createElementBlock("div", _hoisted_2$6, [
        ...
        unref(lastUpdated) ? (openBlock(), createElementBlock("div", _hoisted_3$4, [
          ...
          createBaseVNode("span", _hoisted_5$2, toDisplayString(unref(lastUpdated)), 1)
        ])) : createCommentVNode("", true),
...
var _sfc_main$9 = defineComponent({
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return unref(prevNavLink) || unref(nextNavLink) ? (openBlock(), createElementBlock("nav", _hoisted_1$7, [
        createBaseVNode("p", _hoisted_2$5, [
          ...
          unref(nextNavLink) ? (openBlock(), createElementBlock("span", _hoisted_5$1, [
...
const _hoisted_1$6 = { class: "page" };
const _hoisted_2$4 = { class: "theme-default-content" };
...
const _hoisted_3$2 = /* @__PURE__ */ createBaseVNode("span", { class: "arrow down" }, null, -1);
const _hoisted_4 = ["aria-label"];
const _hoisted_5 = { class: "title" };
const _hoisted_6 = { class: "nav-dropdown" };
const _hoisted_7 = { class: "dropdown-subtitle" };
const _hoisted_8 = { key: 1 };
const _hoisted_9 = { class: "dropdown-subitem-wrapper" };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("button", {
          ...
          createBaseVNode("span", _hoisted_2$3, toDisplayString(unref(item).text), 1),
          _hoisted_3$2
        ], 8, _hoisted_1$5),
        createBaseVNode("button", {
          ...
          createBaseVNode("span", _hoisted_5, toDisplayString(unref(item).text), 1),
          createBaseVNode("span", {
        ...
        createVNode(_sfc_main$7, null, {
          default: withCtx(() => [
            withDirectives(createBaseVNode("ul", _hoisted_6, [
                ...
                return openBlock(), createElementBlock("li", {
                  ...
                  child.children ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                    createBaseVNode("h4", _hoisted_7, [
                      ...
                      }, null, 8, ["item", "onFocusout"])) : (openBlock(), createElementBlock("span", _hoisted_8, toDisplayString(child.text), 1))
                    ]),
...
var _sfc_main$5 = defineComponent({
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return unref(navbarLinks).length ? (openBlock(), createElementBlock("nav", _hoisted_1$4, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(unref(navbarLinks), (item) => {
          return openBlock(), createElementBlock("div", {
            key: item.text,
            class: "navbar-links-item"
          }, [
            item.children ? (openBlock(), createBlock(_sfc_main$6, {
              key: 0,
              item
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("button", {
        ...
        withDirectives((openBlock(), createElementBlock("svg", _hoisted_2$2, _hoisted_12, 512)), [
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("header", {
        ...
        createBaseVNode("span", { ref: siteBrand }, [
        ...
        createBaseVNode("div", {
          ...
          renderSlot(_ctx.$slots, "before"),
          createVNode(_sfc_main$5, { class: "can-hide" }),
          renderSlot(_ctx.$slots, "after"),
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        unref(shouldShowNavbar) ? (openBlock(), createBlock(_sfc_main$2, {
          key: 0,
